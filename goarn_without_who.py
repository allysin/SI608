...
def convert():
    ...
    for i in jasonlist:
        #print matchyear
        if "WHO" not in i["Collaborators"]:
            if "WHO HQ" not in i["Collaborators"]:
                if "WHO_AFRO" not in i["Collaborators"]:
                    if "WHO Collaborating Centre" not in i["Collaborators"]:
                        if "WHO_WPRO" not in i["Collaborators"]:
                            if "WHO DRC" not in i["Collaborators"]:
                                if "WHO Gabon" not in i["Collaborators"]:
                                    if "WHO Georgia" not in i["Collaborators"]:
                                        if "WHO Sri Lanka" not in i["Collaborators"]:
                                            if "WHO_SEARO" not in i["Collaborators"]:
                                                if "WHO Centre for Vulnerability Reduction (WMC) Tunisia" not in i["Collaborators"]:
                                                    if "WHO_Euro"  not in i["Collaborators"]:
                                                        if "WHO collaborating laboratory UK" not in i["Collaborators"]:
                                                            if "WHO China" not in i["Collaborators"]:
                                                                if "WHO Uganda" not in i["Collaborators"]:
                                                                    match.append(i)
                                                                    filename = 'NO_WHO.txt'
