...
goarn_network.add_edge("CDC Atlanta", "WHO HQ",weight=4)
...
goarn_network.add_edge("WHO HQ", "WHO_AFRO",weight=3)
...
goarn_network.add_edge("WHO HQ", "World Food Programme",weight=2)
goarn_network.add_edge("WHO HQ", "World Vision",weight=1)
goarn_network.add_edge("UNICEF", "WHO HQ",weight=4)
...
goarn_network.add_edge("CDC Atlanta", "Epicentre France",weight=3)
...
goarn_network.add_edge("Epicentre France", "UNICEF",weight=3)
...
goarn_network.add_edge("CDC Atlanta", "WHO_AFRO",weight=3)
...
goarn_network.add_edge("CDC Atlanta", "World Food Programme",weight=2)
goarn_network.add_edge("CDC Atlanta", "World Vision",weight=1)
goarn_network.add_edge("CDC Atlanta", "UNICEF",weight=4)
...
goarn_network.add_edge("WHO_AFRO", "World Food Programme",weight=2)
...
goarn_network.add_edge("UNICEF", "World Food Programme",weight=4)
...
goarn_network.add_edge("Ministry of Health DRC", "WHO_AFRO",weight=3)
...
goarn_network.add_edge("CDC Atlanta", "EPIET",weight=2)
...
goarn_network.add_edge("MSF France", "WHO HQ",weight=2)
...
goarn_network.add_edge("Ministry of Health DRC", "WHO HQ",weight=2)
...
goarn_network.add_edge("Bernard-Nocht Institute for Tropical Medicine", "WHO HQ",weight=1)
...
goarn_network.add_edge("Bernard-Nocht Institute for Tropical Medicine", "WHO_AFRO",weight=1)
...
goarn_network.add_edge("Bernard-Nocht Institute for Tropical Medicine", "CDC Atlanta",weight=2)
...
goarn_network.add_edge("CDC Atlanta", "Ministry of Health DRC",weight=1)
...
goarn_network.add_edge("MSF Belgium", "UNICEF",weight=3)
...
goarn_network.add_edge("MSF Holland", "UNICEF",weight=2)
...
goarn_network.add_edge("MSF Spain", "UNICEF",weight=2)
...
goarn_network.add_edge("Bernard-Nocht Institute for Tropical Medicine", "Ministry of Health DRC",weight=1)
...
#import csv
#with open("/Users/grizzlemuff/Documents/SI608/GOARN/zoonosis.csv", 'wb') as csvfile:
